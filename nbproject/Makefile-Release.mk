...
${OBJECTDIR}/BMP085.o: BMP085.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BMP085.o BMP085.cpp
...
${OBJECTDIR}/HMC5883L.o: HMC5883L.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HMC5883L.o HMC5883L.cpp
...
${OBJECTDIR}/OFFSET.o: OFFSET.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OFFSET.o OFFSET.cpp
...
${OBJECTDIR}/ServidorTCP.o: ServidorTCP.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServidorTCP.o ServidorTCP.cpp
