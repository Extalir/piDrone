...
# CC Compiler Flags
CCFLAGS=-pthread -lwiringPi
CXXFLAGS=-pthread -lwiringPi
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/raspidrone: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/raspidrone ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread -lwiringPi

${OBJECTDIR}/Librerias/BMP085/BMP085.o: Librerias/BMP085/BMP085.cpp 
	${MKDIR} -p ${OBJECTDIR}/Librerias/BMP085
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Librerias/BMP085/BMP085.o Librerias/BMP085/BMP085.cpp

${OBJECTDIR}/Librerias/HMC5883L/HMC5883L.o: Librerias/HMC5883L/HMC5883L.cpp 
	${MKDIR} -p ${OBJECTDIR}/Librerias/HMC5883L
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Librerias/HMC5883L/HMC5883L.o Librerias/HMC5883L/HMC5883L.cpp

${OBJECTDIR}/Librerias/I2C/I2Cdev.o: Librerias/I2C/I2Cdev.cpp 
	${MKDIR} -p ${OBJECTDIR}/Librerias/I2C
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Librerias/I2C/I2Cdev.o Librerias/I2C/I2Cdev.cpp

${OBJECTDIR}/Librerias/MPU6050/MPU6050.o: Librerias/MPU6050/MPU6050.cpp 
	${MKDIR} -p ${OBJECTDIR}/Librerias/MPU6050
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Librerias/MPU6050/MPU6050.o Librerias/MPU6050/MPU6050.cpp

${OBJECTDIR}/src/Drone.o: src/Drone.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Drone.o src/Drone.cpp

${OBJECTDIR}/src/GPS.o: src/GPS.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GPS.o src/GPS.cpp

${OBJECTDIR}/src/OFFSET.o: src/OFFSET.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/OFFSET.o src/OFFSET.cpp

${OBJECTDIR}/src/PID.o: src/PID.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PID.o src/PID.cpp

${OBJECTDIR}/src/PlanVuelo.o: src/PlanVuelo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PlanVuelo.o src/PlanVuelo.cpp

${OBJECTDIR}/src/Serial.o: src/Serial.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Serial.o src/Serial.cpp

${OBJECTDIR}/src/ServidorTCP.o: src/ServidorTCP.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ServidorTCP.o src/ServidorTCP.cpp
